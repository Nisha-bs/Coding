...
TD1.start()'''
TD2 = threading.Thread(target = h.input_func, daemon = True)
TD2.start()
TD3 = threading.Thread(target = h.input_func,daemon = True)
TD3.start()
TD4 = threading.Thread(target = h.queue_func, daemon = True)
TD4.start()
#TD1.join()
TD2.join()
TD3.join()
